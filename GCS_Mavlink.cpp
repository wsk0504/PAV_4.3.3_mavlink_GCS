...
// #endif
// 240606 ws.
//const Vector3f &target_pos = copter.pos_control->get_pos_target_cm().tofloat();
//const Vector3f &target_vel = copter.pos_control->get_vel_desired_cms().tofloat();
//const Vector3f &target_acc = copter.pos_control->get_accel_target_cmss().tofloat();
...
static const ap_message STREAM_EXTENDED_STATUS_msgs[] = {
    ...
    MSG_POSITION_TARGET_LOCAL_NED, // 2024-06-07 ws
};
